// Lab_5_final.cpp : Этот файл содержит функцию "main". Здесь начинается и заканчивается выполнение программы.
//
...
void Watch::GetFile(string filename)
{
...
int main()
{
	...
	do {
		...
		case 7:
			...
			cout << "\nIn alphabetical order(Up) \t Vise versa(Down)\n";
			cin >> how;
