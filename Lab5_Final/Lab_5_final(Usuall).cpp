...
struct Watch
{
	...
	bool DelNext(int&, string&, double&, bool&);
	//bool DelPrev(int&, string&, double&, bool&);
	...
	//bool TEST(string D, string FieldName Watch a, Watch b);
...
int main()
{
	...
	//F.AddFirst(1234, "FIRST", 1322, 0);
	//F.AddLast(1234, "erger", 1322, 0);
	//F.MoveLast();
	//F.AddLast(1234, "LAST", 1322, 0);
